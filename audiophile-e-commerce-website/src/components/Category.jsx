...
export default function Category({productImg, productCategory, categoryLink, closeMenu}) {
    return (
        <Link to={categoryLink} onClick={closeMenu} className='category__link uppercase'>
